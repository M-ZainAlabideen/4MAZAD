...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.viewHolder> {
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.item_product_tv_startTime)
        TextView startTime;
    ...
    private void setStartTime(Double startTime, ProductsAdapter.viewHolder viewHolder) {
        ...
        viewHolder.startTime.setText(startHours + context.getString(R.string.hour) + ":" + startMinutes + context.getString(R.string.minute));
    }
