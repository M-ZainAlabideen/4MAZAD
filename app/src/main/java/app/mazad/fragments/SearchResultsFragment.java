...
import app.mazad.adapters.SearchResultsAdapter;
...
public class SearchResultsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.setupAppbar(true, true, false, false, getString(R.string.searchResult));
    ...
    private void searchApi() {
        ...
        RetrofitConfig.getServices().SEARCH_CALL(getArguments().getString(Constants.SEARCH_QUERY),
