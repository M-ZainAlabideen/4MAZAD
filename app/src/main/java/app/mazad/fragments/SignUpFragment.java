...
import app.mazad.adapters.GeneralDialogAdapter;
...
public class SignUpFragment extends Fragment {
    ...
    public void termsAndConditionsClick() {
        Navigator.loadFragment(activity, ContentFragment.newInstance(activity, true), R.id.activity_main_fl_appContainer, false);
    }
    ...
    private void checkName() {
        ...
        if (fullNameTxt == null || fullNameTxt.isEmpty()) {
            fullNameContainer.setError(getString(R.string.enterName));
        } else {
    ...
    private void checkCivilId() {
        ...
        if (civilIdTxt == null || civilIdTxt.isEmpty()) {
            civilIdContainer.setError(getString(R.string.enterCivilId));
        } else {
            if (!FixControl.checkCivilID_12(civilIdTxt) || !GlobalFunctions.validateCivilID(civilIdTxt)) {
                civilIdContainer.setError(getString(R.string.invalidCivilId));
            } else {
    ...
    private void checkUserName() {
        ...
        if (userNameTxt == null || userNameTxt.isEmpty()) {
            userNameContainer.setError(getString(R.string.enterUserName));
        } else {
    ...
    private void signUpApi() {
        ...
        RetrofitConfig.getServices().SIGN_UP_CALL(fullNameReq, mobileReq, emailReq, civilIdReq,
                ...
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        ...
                        if (responseCode == 200) {
                            ...
                            emailContainer.setError(getString(R.string.emailAlreadyExist));
                        } else if (responseCode == 202) {
                            userNameContainer.setError(getString(R.string.userNameAlreadyExist));
                        } else if (responseCode == 203) {
                            mobileContainer.setError(getString(R.string.mobileAlreadyExist));
                        } else if (responseCode == 204) {
                            civilIdContainer.setError(getString(R.string.civilIdAlreadyExist));
                        } else if (responseCode == 205) {
                            civilIdContainer.setError(getString(R.string.civilIdNotValid));
